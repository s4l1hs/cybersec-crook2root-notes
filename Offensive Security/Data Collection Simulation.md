...
**Data Collection Simulation** is one atomic competency within **Lateral Operations & Objectives**. Learn the underlying mechanism before any product syntax: prerequisites, trust boundary, controllable state, security invariant, bounded evidence, business impact, and safe stopping point.

## Visual Attack Flow

```mermaid
flowchart LR
    A["Authorized prerequisite"] --> B["Data Collection Simulation mechanics"]
...
```text
objective=Data Collection Simulation
