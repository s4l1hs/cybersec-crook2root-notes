...
```mermaid
flowchart LR
    A["Controlled input"] --> B["WPA3 Security Testing condition"]
...
A branch-office wireless assessment uses a managed canary client and test SSID to evaluate wpa3 security testing without collecting employee credentials or affecting neighboring networks.
