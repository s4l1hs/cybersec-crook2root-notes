---
title: "Privilege Escalation & Living off the Land"
aliases:
  - Privilege Escalation
  - PrivEsc
  - LoL(Living off the Land) Attacks
  - Living off the Land
  - LOTL
  - LOLBins
  - Post-Exploitation
...
> Everything here is documented for **authorized red-team engagements, isolated enterprise ranges, and incident-response training**. These mechanics are prerequisites for reliable detections—you cannot defend against behavior you do not understand. Never run them against systems you do not own or are not contracted to test.
...
Escalation moves a principal from low privilege to higher effective authority—**horizontal** (another identity at a similar trust level) or **vertical** (administrator/root). In an enterprise assessment it follows foothold validation and ends as soon as the agreed business-impact boundary is proven.
...
- **3.4 Anti-Forensics & ShadowStep** — covering tracks post-escalation
- **3.5 Advanced Defenses** — detecting everything above
- **Tooling (Shells (Reverse & Bind))** — the shell you escalate from
- [[Network Penetration Testing]] — immediate parent
