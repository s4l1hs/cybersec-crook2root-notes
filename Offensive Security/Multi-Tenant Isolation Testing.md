...
In a multi-tenant enterprise service, an authorized assessor discovers multi-tenant isolation testing on a synthetic customer workflow. The proof uses one canary object and stops before accessing production data.
