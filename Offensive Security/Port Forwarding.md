...
A vendor-owned, instrumented laboratory build reproduces port forwarding. The researcher demonstrates only a fixed marker, records mitigation behavior, patches the root cause, and preserves a regression input.
