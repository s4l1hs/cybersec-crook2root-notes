...
In a multi-tenant enterprise service, an authorized assessor discovers cors misconfiguration on a synthetic customer workflow. The proof uses one canary object and stops before accessing production data.
